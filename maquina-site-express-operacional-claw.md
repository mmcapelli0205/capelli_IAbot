# Máquina Site Express — Base Operacional Claw
...
O objetivo não é apenas automatizar mensagens, mas estruturar um sistema comercial **automatizado com governança, limites e auditoria**, capaz de operar com previsibilidade, rastreabilidade e escala controlada.

---

## 2. Objetivo Estratégico

Criar um canal de aquisição automatizado com governança, limites e auditoria para vender sites de entrada com processo padronizado, baixo custo operacional e capacidade de expansão por cidade, nicho e oferta.
...
- integrações reais em produção na fase inicial.
...
### Princípio comercial
O modelo comercial **não terá mensalidade obrigatória**.

A proposta inicial será baseada em:
- **setup / implantação**;
- entrega estruturada do site;
- possíveis adicionais ou evoluções futuras, se fizer sentido.

Ou seja, nesta fase, o projeto não nasce com recorrência obrigatória como premissa comercial.
...
## 7. Política de Aprovação do Cliente

### Regra de aprovação
O cliente poderá recusar a proposta visual **até 2 vezes**.

### Limite operacional
O fluxo deverá prever no máximo:
- **3 opções / apresentações / rodadas visuais** por cliente.

### Interpretação prática
- 1ª apresentação: proposta inicial
- 2ª apresentação: primeiro ajuste após recusa
- 3ª apresentação: segunda e última tentativa

Após isso:
- o caso deve ser revisado;
- escopo, expectativa ou aderência comercial devem ser reavaliados;
- não seguir indefinidamente em ciclos de retrabalho.
...
11. A primeira fase prepara estrutura e valida fluxo, sem executar integrações reais em produção.

---

## 9. Mapa dos Agentes Internos

### 9.1 Agente Pesquisador de Leads
...
### 9.2 Agente Classificador de Oportunidade
...
### 9.3 Agente Gerador de Briefing
...
### 9.5 Agente Copywriter Comercial
...
### 9.7 Agente de Compliance e Opt-out
...
### 9.8 Agente de Pagamento e Onboarding
...
### 9.10 Agente Supervisor de Campanhas
...
### 11.3 Riscos jurídicos e reputacionais
...
### 12.1 Tabelas MVP
Estas tabelas são as mínimas para a primeira fase estrutural do projeto.
...
### 12.2 Tabelas avançadas
Estas entram depois, conforme evolução operacional e ganho de maturidade.
...
- [ ] política de até 3 apresentações aprovada
...
- [ ] checkout decidido
- [ ] backup definido
- [ ] fase 1 delimitada como estrutural, sem integrações reais em produção
...
### Reforço de fase 1
Na primeira fase, o objetivo do Claude Code é **preparar a estrutura**, validar arquitetura, estados, tabelas, interfaces e fluxo.

Não é objetivo da fase 1:
- disparar campanhas reais;
- enviar mensagens reais;
- ativar cobrança real;
- operar integrações reais em produção.
...
## 19. Recomendação Estratégica de Lançamento
